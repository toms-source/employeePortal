            ...
            <tbody>
                @foreach ($docuReq as $docuReqs)
                    <tr class="text-center">
                        ...
                        <td>
                            @if($docuReqs->file_path) <!-- If the file_path is not null, display the document link -->
                             <a href="{{ asset('storage/' . $docuReqs->file_path) }}" target="_blank">Document</a>
                            @elseif(($docuReqs->file_path)==null)
                                No File Uploaded
                            @endif
                        </td>
                        {{-- <td>  --}}
