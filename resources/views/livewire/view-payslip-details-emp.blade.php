            ...
            <div class="col">
                ...
                <div class="shadow border fw-bold p-3 mb-3 bg-white rounded">
                    ...
                    <div class="card-body py-5">
                        <h5 class="shadow border fw-bold p-3 mb-3 bg-white rounded">Earnings: </h5> 
                        ...
                        <h5 class="shadow border fw-bold p-3 mb-3 bg-white rounded">Total Gross Income: {{$salaryRecord[0]->allowance + $payslipRecord[0]->gross_pay}}</h5> 
                    </div>
                    <div class="card-body py-5">
                        <h5 class="shadow border fw-bold p-3 mb-3 bg-white rounded">Deductions: </h5>
                        ...
                        <h5 class="shadow border fw-bold p-3 mb-3 bg-white rounded">Total Gross Income: {{$payslipRecord[0]->net_pay}}</h5> 
