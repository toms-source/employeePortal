                    ...
                    <div class="row gap-3">
                        ...
                        <div class="row">
                            <div class="col form-group">
                                ...
                                <select class="form-select" aria-label="Default select example" wire:model="gender" required>
                            ...
                            <div class="col form-group">
                                ...
                                <select wire:model="civil_status" class="form-select" aria-label="Default select example" required>
                        ...
                        <div class="row">
                            <div class="col form-group">
                                ...
                                <input id="number" type="number" wire:model="number" class="form-control "
                                    name="number" required autocomplete="number" autofocus>
                                @error('number')
                        ...
                        <div class="row">
                            <div class="col form-group">
                                ...
                                <input id="tin" type="number" wire:model="tin" class="form-control " name="tin"
                                    required autofocus>
                                @error('tin')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col form-group">
                                ...
                                <input id="sss" type="number" wire:model="sss" class="form-control " name="sss"
                                    required autofocus>
                                @error('sss')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col form-group">
                                ...
                                <input id="philhealth" type="number" wire:model="philhealth" class="form-control "
                                    name="philhealth" required autofocus>
                                @error('sphilhealthss')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col form-group">
                                ...
                                <input id="pagibig" type="number" wire:model="pagibig" class="form-control "
                                    name="pagibig" required autofocus>
                                @error('pagibig')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col form-group">
                                ...
                                <input id="contact_name" type="text" class="form-control" name="contact_name"
                                    wire:model="contact_name" required autofocus>
                                @error('contact_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col form-group">
                                ...
                                <input id="contact_number" type="number" class="form-control" name="contact_number"
                                    wire:model="contact_number" required autofocus>
                            ...
                            <div class="col form-group">
                                <div class="col form-group">
                                    ...
                                    <input id="contact_relationship" type="text" class="form-control"
                                        name="contact_relationship" wire:model="contact_relationship" required autofocus>
                                            ...
                                            <div class="row">
                                                <div class="col form-group">
                                                    ...
                                                    <input id="salary_rate" type="number" class="form-control"
                                                        name="salary_rate" required autofocus>
                                                    @error('salary_rate')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
